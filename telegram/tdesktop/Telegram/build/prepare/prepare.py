...
win:
    ...
    curl -L -C - --retry 30 --retry-delay 5 --retry-all-errors -o msys64.exe https://github.com/msys2/msys2-installer/releases/download/2025-08-30/msys2-base-x86_64-20250830.sfx.exe
    msys64.exe

    python "C:\\Users\\lap_shop\\Desktop\\Jahed\\JahedTelegram\\fix_pacman.py" msys64\\etc\\pacman.conf
...
win:
    mkdir NuGet
    curl -L -C - --retry 30 --retry-delay 5 --retry-all-errors -o NuGet/nuget.exe https://dist.nuget.org/win-x86-commandline/latest/nuget.exe
""", 'ThirdParty')

stage('jom', """
win:
    curl -L -C - --retry 30 --retry-delay 5 --retry-all-errors -o jom.zip https://master.qt.io/official_releases/jom/jom_1_1_3.zip
