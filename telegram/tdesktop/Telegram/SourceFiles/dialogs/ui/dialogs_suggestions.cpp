...
std::vector<Suggestions::Key> Suggestions::TabKeysFor(
		not_null<Window::SessionController*> controller) {
	// Puregram: the Channels, Apps and Posts tabs are discovery surfaces
	// (recommended channels, popular apps, public-post search) and are
	// removed (POLICY_SPEC §4); local chats, media and downloads stay.
