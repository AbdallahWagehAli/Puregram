...
#include "puregram/puregram_whitelist.h" // Puregram: device-language app display name
...
void MainWindow::updateTitle() {
	...
	if (!thread) {
		// Puregram: brand the window/taskbar title (device-language aware).
		setTitle((user.isEmpty() ? Puregram::AppDisplayName() : user) + added);
		return;
	}
