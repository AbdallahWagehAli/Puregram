...
public class SMSJobsNotification extends Service {
    ...
    /**
     * Puregram: always false. The service this used to start is no longer declared in the
     * manifest — it belonged to Telegram's SMS-relay programme, whose SEND_SMS and
     * READ_CALL_LOG permissions were removed, so the programme can never be joined.
     */
