...
public class ThemeColors {
    ...
    public static final int TELEGRAM_COLOR = 0xFF2E9E4F;        // Puregram brand green (was 0xFF229AF0)
    public static final int TELEGRAM_COLOR_TEXT = 0xFF1E7A3C;   // Puregram brand green-deep (was 0xFF298ACF)
