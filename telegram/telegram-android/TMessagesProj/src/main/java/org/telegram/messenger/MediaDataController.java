...
//            }
    ...
    public void searchStickerSets(boolean emojis, String query, Utilities.Callback<ArrayList<TLRPC.StickerSetCovered>> callback) {
        if (!PuregramRules.STICKER_SEARCH_ENABLED) {
            // Puregram: searching the public sticker-set index is a discovery
            // surface. Installed, featured and emoji-suggested stickers are
            // untouched; only the search box comes back empty.
