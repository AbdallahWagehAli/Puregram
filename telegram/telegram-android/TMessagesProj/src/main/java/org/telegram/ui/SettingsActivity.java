...
//        fragmentView.addView(navigationBar, LayoutHelper.createFrame(LayoutHelper.MATCH_PARENT, 0, Gravity.BOTTOM | Gravity.FILL_HORIZONTAL));
    ...
    private void fillItems(ArrayList<UItem> items, UniversalAdapter adapter) {
        ...
        // Puregram: the user's own allow / block lists (POLICY_SPEC §7). Sits next
        // to Privacy because that is what people come here looking for.
        ...
        // Puregram: supervision is managed entirely from the web panel
        // (https://puregram.app/app/). The app itself carries no supervision
        // screens — a link request arrives as a notification, nothing else.
