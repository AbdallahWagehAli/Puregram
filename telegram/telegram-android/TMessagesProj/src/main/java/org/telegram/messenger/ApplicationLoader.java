...
public class ApplicationLoader extends Application {
    ...
    public void onCreate() {
        ...
        // Puregram: start the device check-in + whitelist sync loop (only behavioural
        // change vs stock Telegram). Best-effort; never blocks app startup.
        try {
            PuregramRules.init(applicationContext);
        } catch (Throwable ignore) {
        }
    }
