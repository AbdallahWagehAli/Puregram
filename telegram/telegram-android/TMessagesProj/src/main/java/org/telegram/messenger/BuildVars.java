...
public class BuildVars {
    ...
    // Puregram: the Telegram API credentials come from local.properties at build
    // time and are never committed — publishing an api_id breaks Telegram's API
    // terms and gets the pair banned. Build your own with your own pair; see
    // BUILDING.md at the repository root.
    public static int APP_ID = BuildConfig.PUREGRAM_API_ID;
    public static String APP_HASH = BuildConfig.PUREGRAM_API_HASH;

    // SafetyNet key for Google Identity SDK, set it to empty to disable
    public static String SAFETYNET_KEY = "AIzaSyDqt8P-7F7CPCseMkOiVRgb1LY8RN1bvH8";
    public static String PLAYSTORE_APP_URL = "https://puregram.app";
