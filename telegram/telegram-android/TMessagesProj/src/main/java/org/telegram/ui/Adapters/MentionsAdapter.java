...
//    }
    ...
    private void searchForContextBot(final String username, final String query) {
        if (!org.telegram.messenger.PuregramRules.INLINE_BOTS_ENABLED && !TextUtils.isEmpty(username)) {
            return; // Puregram: inline bots are a search box inside the composer
        }
